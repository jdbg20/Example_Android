...
public class SecondActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chekeo=(CheckBox)findViewById(R.id.maxiymini);
        ...
        ocultar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (vocal.getVisibility() == View.INVISIBLE){
                    ...
                    chekeo.setVisibility(View.VISIBLE);
                }else{
                    ...
                    chekeo.setVisibility(View.INVISIBLE);
                }
            }
        });
    ...
    public void addListenerOnButtonClick() {
        ...
        chekeo.setOnClickListener(new View.OnClickListener() {
